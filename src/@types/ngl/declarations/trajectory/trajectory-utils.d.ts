...
export declare function makeTrajectory(trajSrc: string | Frames, structure: Structure, params: TrajectoryParameters): FramesTrajectory | StructureTrajectory | RemoteTrajectory;
